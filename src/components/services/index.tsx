      ...
      <div className="mt-10 space-y-6">
        {services.map((service, index) => (
          <motion.div
            ...
            className="group border border-transparent  hover:border-[#BFF747] bg-[#0E0E0E] rounded-3xl flex flex-wrap items-center gap-5 md:p-10 p-5 text-white font-bigshoulders lg:flex-nowrap xl:gap-40 transition-all duration-300 overflow-hidden relative"
          >
            <p className="text-[24px] font-semibold">{service.id}</p>

            <p className="text-[24px] w-full md:w-[20%] font-semibold">
              {service.title}
            </p>

            <p className="w-full md:w-[45%] text-base font-normal font-bricolage">
              {service.description}
            </p>
